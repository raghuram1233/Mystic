...
"background-color: rgb(73, 80, 87);")
        ...
        self.app_grid_frame.setStyleSheet("background-color: rgb(52,58,64);")
    ...
    def airesponse(self,query):
        ...
        if 'wikipedia' in query:
            ...
            if 'search' in query:
                ...
                webbrowser.open(yt)
                self.chat+=f'Response: Results for {query}'
            
            else :    
                webbrowser.open("youtube.com")
                self.chat+='Response: YouTube Has Been Launched'
                        

        elif 'open google' in query:
            webbrowser.open("google.com")
            self.chat+='Response: Brave Has Been Launched'

        elif 'anime' in query:
            webbrowser.open("https://animesuge.to/home")
            self.chat+='Response: Website Has Been Launched'
        
        elif 'time' in query:
            strtime = datetime.datetime.now().strftime("%H:%M:%S")
            var = f"the time is {strtime}"
            self.chat+='Response: '+var
        ...
        #writing notes
            ...
            self.chat+='Response: evrything is saved in notes'
        ...
        #refreshing total page
            ...
            try:
                self.chat+= f'\nResponse : {eval(self.search_field.text())}'
            except:
                self.chat+='Response: no match'
    ...
    def Refresh_grid_apps(self):
        ...
        for app_no in range(no_of_apps):
            self.app_grid_layout.itemAt(app_no).widget().clicked.connect(lambda _, i=app_no: subprocess.Popen(app_paths_list[i]))
